...
public class PoiUtil {
	...
	public static ResponseEntity<byte[]> employeeToExcel(List<Employee> list) {
		...
		// 文档管理员
		docInfo.setManager("dahuang");
		// 设置公司信息
		docInfo.setCompany("www.cskj.org");
		// 4. 获取文档摘要信息
		SummaryInformation summInfo = workbook.getSummaryInformation();
		// 文档标题
		summInfo.setTitle("员工信息表");
		// 文档作者
		summInfo.setAuthor("大黄");
		// 文档备注
		summInfo.setComments("本文档由大黄提供");
		// 5. 创建样式
		// 创建标题行的样式
	...
	public static List<Employee> excelToEmployee(MultipartFile file, List<Department> allDepartments,
			List<Nation> allNations, List<Position> allPositions, List<JobLevel> allJobLevels,
			List<Politicsstatus> allPol) {
					...
					for (int k = 0; k < physicalNumberOfCells; k++) {
						...
						case STRING:
							...
							case 8:
								...
								break;
							case 9:
								int politicstatusIndex = allPol.indexOf(new Politicsstatus(cellValue));
								employee.setPoliticId(allPol.get(politicstatusIndex).getId());
								break;
							case 10:
